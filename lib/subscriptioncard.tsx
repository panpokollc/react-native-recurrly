...
import { formatCurrency, formatSubscriptionDateTime, formatStatusLabel } from "./utils";
...
const SubscriptionCard = ({ name, price, currency, icon, billing, color, category, 
  ...
  return (
    <Pressable onPress={onPress} className={clsx('sub-card', 
        expanded ? 'sub-card-expanded' : 'bg-card')} style={!expanded && color ? { 
        ...
        <View className="sub-head">
            ...
            <View className="sub-price-box">
                <Text className="sub-price">{formatCurrency(
                price, currency)}</Text> 
